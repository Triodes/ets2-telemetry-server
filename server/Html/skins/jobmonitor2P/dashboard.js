...
var tOffLine1 = 'Start the game and get in a truck cabin';
...
Funbit.Ets.Telemetry.Dashboard.prototype.initialize = function (skinConfig, utils) {
    ...
    if (navigator.language.substring(0, 5).toLowerCase() === 'pt-br') {
        ...
        document.getElementById('tSummary').innerHTML = 'Summary';
        document.getElementById('tNavDate').innerHTML = 'Date:';
        document.getElementById('tNavDeadline').innerHTML = 'Deadline:';
        document.getElementById('tNavCargo').innerHTML = 'Cargo:';
        document.getElementById('tNavWeight').innerHTML = 'Weight:';
        document.getElementById('tNavFrom').innerHTML = 'From:';
        document.getElementById('tNavTo').innerHTML = 'To:';
        document.getElementById('tNavDistance').innerHTML = 'Distance:';
        document.getElementById('tNavRange').innerHTML = 'Range:';
        document.getElementById('tNavRemaining').innerHTML = 'Remaining:';
        document.getElementById('tNavRevenue').innerHTML = 'Revenue:';
        document.getElementById('tNavUnit').innerHTML = 'Unit:';
        document.getElementById('tEM').innerHTML = 'WoT Job';
        document.getElementById('tEMTime').innerHTML = 'Time:';
        document.getElementById('tEMDeadline').innerHTML = 'Deadline:';
        document.getElementById('tEMRemainingTime').innerHTML = 'Remaining Time:';
        document.getElementById('tEMDays').innerHTML = 'Days:';
        document.getElementById('tEMHours').innerHTML = 'Hours:';
        document.getElementById('tEMMinutes').innerHTML = 'Minutes:';
        document.getElementById('tEMSubmit').innerHTML = 'Submit';
        document.getElementById('tDamage').innerHTML = 'Damage';
        document.getElementById('tDamageCargo').innerHTML = 'Cargo:';
        document.getElementById('tDamageTrailer').innerHTML = 'Trailer';
        document.getElementById('tDamageTrailerChassis').innerHTML = 'Chassis:';
        document.getElementById('tDamageTrailerWheels').innerHTML = 'Wheels:';
        document.getElementById('tDamageTruck').innerHTML = 'Truck';
        document.getElementById('tDamageTruckEngine').innerHTML = 'Engine:';
        document.getElementById('tDamageTruckCabin').innerHTML = 'Cabin:';
        document.getElementById('tDamageTruckChassis').innerHTML = 'Chassis:';
        document.getElementById('tDamageTruckWheels').innerHTML = 'Wheels:';
        document.getElementById('tProgress').innerHTML = 'Progress';
        document.getElementById('tProgressActual').innerHTML = 'Actual';
        document.getElementById('tProgressActualEstimated').innerHTML = 'Estimated:';
        document.getElementById('tProgressActualStops').innerHTML = 'Stops:';
        document.getElementById('tProgressActualRemaining').innerHTML = 'Remaining:';
        document.getElementById('tProgressActualLeaving').innerHTML = 'Leaving:';
        document.getElementById('tProgressMinimal').innerHTML = 'Minimal';
        document.getElementById('tProgressMinimalEstimated').innerHTML = 'Estimated:';
        document.getElementById('tProgressMinimalStops').innerHTML = 'Stops:';
        document.getElementById('tProgressMinimalRemaining').innerHTML = 'Remaining:';
        document.getElementById('tProgressMinimalLeaving').innerHTML = 'Leaving:';
        document.getElementById('tProgressResting').innerHTML = 'If Stop';
        document.getElementById('tProgressRestingEstimated').innerHTML = 'Estimated:';
        document.getElementById('tProgressRestingStops').innerHTML = 'Stops:';
        document.getElementById('tProgressRestingRemaining').innerHTML = 'Remaining:';
        document.getElementById('tProgressRestingLeaving').innerHTML = 'Leaving:';

        tPaused = 'Paused';
        tEMWarning1 = "Unfortunately, the jobs for the World of Truck don't update the remaining time, so we can't calculate speeds and rest stops.";
        tEMWarning2 = 'Please, pause the game, and enter above the Remaining Time shown in the top-left corner of the main screen.';
        tEMWarning3 = 'Tap elsewhere to close this table.';
        tOffLine1 = 'Start the game and get in a truck cabin';
        tOffLine2 = "Check your wi-fi or relaunch the ETS2Telemetry if you're already driving";
        tSlowDown = 'Slow Down';
        tTo = 'To: ';
        tImpossibleSchedule = 'Undoable schedule';
        tScheduleCompromised = 'Schedule is compromised';
        tRestNextStop = 'Rest at next stop';
        tConsiderStop = 'Consider stop for rest';
        tScheduleSeemsGood = 'schedule seems good';
        tScheduleMayBeCompromised = 'schedule may be compromised';
        tWithinCityLimits = 'within city limits';
        tYouNeedRest = 'You NEED to rest';
        tGoodTimeRest = 'Good time to rest';
        tRestIfWish = 'Rest if you wish';
        tDontNeedRest = "You don't need to rest";
        tDoNotRest = 'Do NOT rest';
        tDeliveryOverdue = 'The delivery is overdue';
        tDeliveryLast1h = 'Last than 1h to deadline';
        tDeliveryLast2h = 'Last than 2h to deadline';
        tScheduleOk = 'Schedule seems ok';
        tSpeedUp = 'Better speed up';
        tRepairTheTruck = 'Repair the truck';
        tChangeTruckTyres = 'Change truck tyres';
        tKilometer = 'Kilometer';
        tMiles = 'Miles';
        tKPH = 'km/h';
        tMPH = 'mph';
...
SetTruck = function (data) {
    if (trucklLicensePlate === data.truck.licensePlate && truckWheelCount === data.truck.wheelCount && data.truck.wearWheels > truckWearWheels) {
        truckWearWheels = data.truck.wearWheels;
        return;
    }
...
SetTrailer = function (data) {
    if (trailer0LicensePlate === data.trailers[0].licensePlate && trailerWheelCount === data.trailers[0].wheelCount && data.trailers[0].wearWheels > trailerWearWheels) {
        trailerWearWheels = data.trailers[0].wearWheels;
        return;
    }
...
Funbit.Ets.Telemetry.Dashboard.prototype.filter = function (data, utils) {
    ...
    if (jobWoT) {
        ...
        if (deadlineTimeEM > zDay) {
            ...
            data.navigation.message =
                ...
                "<font color='#5e4d29'>" + tEMWarning3 + "</font>";
        }
    }

    //message += 'Dist Truck-Trailer 0: ' + utils.formatFloat(data.trailers[0].distance, 6) + lb;
    //message += 'Dist Truck-Trailer 1: ' + utils.formatFloat(data.trailers[1].distance, 6) + lb;
    //message += 'Trailers: ' + data.trailers + lb;

    if (data.game.connected === false) {
        jobWoT = false;
        message += tOffLine1 + lb + '<font style="font-size: 50%;">' + tOffLine2 + '</font>';
    }
    ...
    //message += data.trailers[0].wheelCount + lb + data.trailers[1].wheelCount;
    ...
    if (data.truck.engineRpm === 0 && data.hasJob) {
        if (data.driverFatigueTime < 60) {
            ...
            message += '<font style="font-size: 100px;">' + tDoNotRest + '</font>' + lb;
        }
        if (data.navigation.newMinimalSpeed < 50) {
    ...
    data.realEstimatedTime = data.game.paused && !jobWoT ? "<font style='font-size: 75px;'>" + tPaused + "</font>" : data.realEstimatedTime;
