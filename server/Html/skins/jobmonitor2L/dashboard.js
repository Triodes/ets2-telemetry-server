...
Funbit.Ets.Telemetry.Dashboard.prototype.filter = function (data, utils) {
    ...
    message += 'gear: ' + data.truck.gear + lb;
    message += 'displayedGear: ' + data.truck.displayedGear + lb;
    message += 'shifterSlot: ' + data.truck.shifterSlot + lb;
    message += 'shifterToggle: ' + data.truck.shifterToggle + lb;
